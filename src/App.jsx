...
<div style={{background:"white",borderRadius:12,width:"100%",maxWidth:420,boxShadow:"0 20px 60px rgba(0,0,0,.5)"}}>
<div id="_slip_setor" style={{background:"white",padding:20,fontFamily:"Arial,sans-serif",color:"#111",borderRadius:12}}>
{/* Header */}
<div style={{display:"flex",alignItems:"center",justifyContent:"space-between",borderBottom:"2px solid #0a1f44",paddingBottom:10,marginBottom:10}}>
<img src={logoSrc} style={{height:45,objectFit:"contain"}} alt="Logo HTS"/>
</div>
